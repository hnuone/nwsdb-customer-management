const TRANSLATIONS = {
    ...
    si: {
        ...
        'Please fill all fields': 'කරුණාකර සියලු ක්ෂේත්‍ර පුරවන්න',
        'Passwords do not match': 'මුරපද ගැලපෙන්නේ නැත',
        'Password must be at least 4 characters': 'මුරපදය අවම වශයෙන් අක්ෂර 4 ක් විය යුතුය',
        'Username already exists': 'පරිශීලක නම දැනටමත් පවතී',
        'Account created successfully. Please wait for admin verification.': 'ගිණුම සාර්ථකව සාදන ලදී. පරිපාලක තහවුරු කිරීම සඳහා රැඳී සිටින්න.',
        'Your account is not yet verified. Please contact the administrator.': 'ඔබගේ ගිණුම තවමත් තහවුරු කර නොමැත. කරුණාකර පරිපාලක අමතන්න.',
